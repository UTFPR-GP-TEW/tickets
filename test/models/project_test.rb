...
class ProjectTest < ActiveSupport::TestCase
  ...
  test "should not duplicate token" do
    ...
    assert_difference('Project.count', 1) do
      Project.create name: 'None1', description: 'None1', token: token, parent_project_id: nil
      Project.create name: 'None2', description: 'None2', token: token, parent_project_id: nil
    end
  end
end
